# Religious & Christianity Trends — 2026-03-29
...
### Hallow
- No new major features or funding since Series C (May 2023, $157M total). 315 employees as of February 2026.
- Expanding parish partnership program. Added widgets and Apple Health integration.
- Tucker Carlson Lenten partnership controversy (February 2026).
- User base is 40% non-Catholic (25M downloads). Watch for formal expansion beyond Catholic core.
- No movement toward "intentional/minimal" product philosophy. Still content-volume oriented.
...
- Visual rebrand (new logo + app design). Participated in Global Bible Month (Nov 2025).
- 20M+ claimed users, 43 employees, $84.6M total funding (a16z-led). Latest update March 18, 2026.
...
- Abide / First15 — no significant 2026 news found.

## Church Technology

### Pushpay
- AI across entire product suite (December 2025): AI People Search, AI Giving Data, Studio AI (sermon-to-content), Genny (AI support agent).
- 2026 State of Church Technology Report with Barna (March 9, 2026): 1,300+ church leaders surveyed. 95% say tech opens new opportunities. A third of churches use AI. 80%+ concerned about data privacy. Only 5% have formal AI policies.
- Church AI Policy Generator launched March 2026.
- Pushpay Goes grant for church planters (March 16, 2026): free enterprise stack for one year.
- 14,000+ churches, $235M in at-risk donations secured annually.
- Crypto donations up 73%, stock donations up 105%.

### ChMS Landscape
- Planning Center leads in comprehensive ChMS. Tithe.ly leads in mobile giving ($99/month).
- Subsplash leads in media/apps (acquired Pulpit AI in 2024 for AI sermon repurposing).

## Faith Consumer Behavior
- 87% research churches online before visiting.
- 1 in 3 trust AI spiritual advice as much as a pastor's (2 in 5 among Gen Z/Millennials).
- 4 in 10 practicing Christians say AI has helped with prayer, Bible study, or spiritual growth.
- 6 in 10 U.S. adults engage with Christian media; half weekly.
- Gen Z: 59% use Bible apps, ~33% listen to faith podcasts, ~25% use TikTok for faith content.

### Gender Gap
- Men: 43% attend regularly vs. women: 36% — largest gap Barna has recorded.
- Millennial men: 55% attended past week vs. Millennial women: 38%.
- Gen Z women disaffiliating at record rates.

## Faith + AI
- 43% of Protestant pastors have experimented with AI (up from 12% in 2022).
- Key tools: SermonAI, Sermonly, SermonSpark, Pastors.ai, Logos, FaithFlow, Gloo.
- AI translation enabling multilingual services (50+ languages, no app download).
- Church AI adoption gap: widespread interest but only 5% have formal AI policies.
