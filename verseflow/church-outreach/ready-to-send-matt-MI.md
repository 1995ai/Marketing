# Church Outreach — Matt's MI Emails (Ready to Send)
> Last Updated: 2026-04-06
> Status: READY — Copy/paste each email
> Promo Code: RISEUP (first month free, 500 uses, expires May 31, 2026)
> Sender: matt@myverseflow.app
> Reply-to: matt@myverseflow.app
...
4. Track replies in tracking.md
5. Follow-up emails (Email 2 on Day 5, Email 3 on Day 10) — templates in email-sequence.md

---

## PRIORITY 1 — Relocation Area (Strongest Personal Connection)

### Email 1 — Brightmoor Christian, Novi
...
### Email 2 — Holy Family Parish, Novi
...
### Email 3 — Our Lady of Refuge, Orchard Lake
...
### Email 4 — Ward Church, Northville ⭐ Top Target
...
## PRIORITY 2 — Metro Detroit / Bloomfield Hills / Birmingham

### Email 5 — Kirk in the Hills, Bloomfield Hills
...
### Email 6 — First Presbyterian Birmingham
...
### Email 7 — St. James Episcopal, Birmingham
...
### Email 8 — Christ Church Cranbrook, Bloomfield Hills
...
## PRIORITY 3 — Grand Rapids

### Email 9 — Westminster Presbyterian, Grand Rapids
...
## NEEDS EMAIL VERIFICATION (Sentinel researching overnight)
...
## Send Schedule (Matt — MI)

| Day | Batch | Count |
|-----|-------|-------|
| Tuesday AM | Relocation: #1 Brightmoor, #2 Holy Family, #3 Our Lady of Refuge, #4 Ward | 4 |
| Wednesday AM | Metro Detroit: #5 Kirk in Hills, #6 FPC Birmingham, #7 St. James, #8 Cranbrook | 4 |
| Thursday AM | Grand Rapids: #9 Westminster + verified emails from overnight research | 1+ |

Send between 9-10am ET. Avoid Monday and Friday.

## Coming This Week
Sentinel is researching 50-75 more MI churches with verified emails. Next batch drops by Wednesday.
